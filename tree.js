module.exports = {gen_tree_data, tree_tpl}

function tree_tpl (str) {
  return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no"><meta name="theme-color" content="#000000"><title>文件树形统计</title><link href="https://cdn.jsdelivr.net/gh/iwestlin/foldertree/dist/min.css" rel="stylesheet"></head><body><noscript>请先启用JavaScript支持</noscript><div id="root"></div><script type="text/javascript">var treedata = ${str}</script><script type="text/javascript" src="https://cdn.jsdelivr.net/gh/iwestlin/foldertree/dist/min.js"></script></body></html>`
}
